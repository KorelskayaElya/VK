...
class FurtherInformationViewController: UIViewController {
    ...
    // MARK: - UI
    private lazy var usernameLabel = LabelFutherInformationField()
    private lazy var usernameLabel1 = LabelFutherInformationField()
    private lazy var statusLabel = LabelFutherInformationField()
    private lazy var statusLabel1 = LabelFutherInformationField()
    private lazy var genderLabel = LabelFutherInformationField()
    private lazy var genderLabel1 = LabelFutherInformationField()
    private lazy var birthdayLabel = LabelFutherInformationField()
    private lazy var birthdayLabel1 = LabelFutherInformationField()
    private lazy var cityLabel = LabelFutherInformationField()
    private lazy var cityLabel1 = LabelFutherInformationField()
    private lazy var hobbyLabel = LabelFutherInformationField()
    private lazy var hobbyLabel1 = LabelFutherInformationField()
    private lazy var schoolLabel = LabelFutherInformationField()
    private lazy var schoolLabel1 = LabelFutherInformationField()
    private lazy var universityLabel = LabelFutherInformationField()
    private lazy var universityLabel1 = LabelFutherInformationField()
    private lazy var workLabel = LabelFutherInformationField()
    private lazy var workLabel1 = LabelFutherInformationField()
    ...
    override func viewDidLoad() {
        ...
        title = "Furhter information".localized
        setupView()
        constraints()
    }
    ...
    private func setupView() {
        ...
        usernameLabel1.text = "Name Surname".localized
        genderLabel1.text = "Gender".localized
        birthdayLabel1.text = "Birthaday".localized
        cityLabel1.text = "Native city".localized
        hobbyLabel1.text = "Hobby".localized
        schoolLabel1.text = "School".localized
        universityLabel1.text = "University".localized
        workLabel1.text = "Work".localized
        statusLabel1.text = "Status".localized
